...
NVAPI_FUNCTION NvAPI_GPU_GetPstatesInfo(NvPhysicalGpuHandle hPhysicalGpu, NV_GPU_PERF_PSTATES_INFO *pPstatesInfo) {
    ...
    if(pPstatesInfo->version != NV_GPU_PERF_PSTATES_INFO_VER1 && pPstatesInfo->version != NV_GPU_PERF_PSTATES_INFO_VER2 && pPstatesInfo->version != NV_GPU_PERF_PSTATES_INFO_V>
        return IncompatibleStructVersion(n, pPstatesInfo->version);
